...
void AffichageSelectionLuminosite(int * rouge, int * vert, int * bleu)
{
  int selection = 0;
  int estSelectionne = 0;
...
void AffichageSelectionConfiguration()
{
...
void SousMenu1()
{
  ...
  while (1)
  {
    ...
    display.println("Sous menu 1");

    display.setCursor(10, 10);
    display.println("Appuyez sur le boutton pour sortir");
